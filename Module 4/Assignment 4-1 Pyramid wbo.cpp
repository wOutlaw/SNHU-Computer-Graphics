...
void UCreateBuffers()
{
	...
	GLfloat vertices[] = {
		// Vertex positions			// Colors
		 0.0f,  0.5f,  0.0f,		1.0f, 1.0f, 0.5f,	// 0 top of pyramid
		 0.5f, -0.5f,  0.5f,		0.0f, 1.0f, 0.0f,	// 1 front right
		-0.5f, -0.5f,  0.5f,		0.0f, 0.0f, 1.0f,	// 2 front left
		 0.5f, -0.5f, -0.5f,		1.0f, 0.0f, 0.5f,	// 3 back right
		-0.5f, -0.5f, -0.5f,		0.5f, 0.5f, 1.0f,	// 4 back left
	};
